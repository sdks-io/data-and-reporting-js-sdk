...
|  --- | --- | --- | --- |
| `includePayerGroup` | `boolean \| undefined` | Optional | True/False. The output will include the payer group information only when true is passed.<br><br>**Default**: `false` |
| `includeEIDDetails` | `boolean \| undefined` | Optional | True/False. The output will include the EID (Electronic Invoice data) information only when true is passed..<br><br>**Default**: `false` |
