...
|  --- | --- | --- | --- |
| `pageSize` | `number` | Required | Specify the number of records to returned; Max 1000<br><br>**Constraints**: `>= 1`, `<= 1000` |
| `page` | `number` | Required | Specify the page of results to be returned.<br><br>**Constraints**: `<= 1` |
