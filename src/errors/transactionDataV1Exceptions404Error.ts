...
/**
 * Creates an instance of TransactionDataV1Exceptions404
 */
interface TransactionDataV1Exceptions404 {
...
export class TransactionDataV1Exceptions404Error extends ApiError<
  TransactionDataV1Exceptions404
> {}
