...
export const pricedTransactionResponseTransactionsItemsSchema: Schema<PricedTransactionResponseTransactionsItems> = lazy(
  () =>
    object({
      ...
      location: [
        'Location',
        optional(
          array(pricedTransactionResponseTransactionsItemsLocationSchema)
        ),
      ],
