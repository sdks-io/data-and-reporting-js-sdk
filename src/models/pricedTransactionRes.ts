...
export const pricedTransactionResSchema: Schema<PricedTransactionRes> = object({
  requestId: ['RequestId', optional(string())],
  status: ['Status', optional(string())],
  data: ['Data', optional(array(lazy(() => pricedTransactionResponseSchema)))],
