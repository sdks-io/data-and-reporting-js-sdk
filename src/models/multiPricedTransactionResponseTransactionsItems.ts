...
export const multiPricedTransactionResponseTransactionsItemsSchema: Schema<MultiPricedTransactionResponseTransactionsItems> = lazy(
  () =>
    object({
      ...
      location: ['Location', optional(array(siteLocationSchema))],
